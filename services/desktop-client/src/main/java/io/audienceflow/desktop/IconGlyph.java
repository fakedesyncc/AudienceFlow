...
public final class IconGlyph extends StackPane {
    ...
    private static String path(Name name) {
        return switch (name) {
            ...
            case LINE -> "M4 18L18 4L20 6L6 20L4 18ZM5 8A3 3 0 1 1 5 2A3 3 0 0 1 5 8ZM5 6A1 1 0 1 0 5 4A1 1 0 0 0 5 6ZM19 22A3 3 0 1 1 19 16A3 3 0 0 1 19 22ZM19 20A1 1 0 1 0 19 18A1 1 0 0 0 19 20Z";
            ...
            case REPORT -> "M5 3H16L20 7V21H5V3ZM15 5V8H18L15 5ZM8 11H17V13H8V11ZM8 15H17V17H8V15ZM8 7H12V9H8V7Z";
